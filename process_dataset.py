...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--dir',
                       help='process files in specified local directory, e.g. /home/user/data/JPST001914', required=True)
    ...
    local_dir = args.dir
    project_identifier_to_use = args.identifier
    ...
    for file in os.listdir(local_dir):
        if file.endswith(".mzid") or file.endswith(".mzid.gz"):
            ...
            writer = Writer(conn_str, pxid=project_identifier_to_use)
